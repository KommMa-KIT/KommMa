...
describe('GraphViewCanvas', () => {
  beforeEach(() => {
    jest.clearAllMocks();
    capturedGraphProps = {};
    // Restore after clearAllMocks wipes the jest.fn() implementations
    mockOnNodeClick.mockImplementation(() => {});
    mockOnCanvasClick.mockImplementation(() => {});
  });
